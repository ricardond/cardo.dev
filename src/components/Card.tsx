...
export default function Card({titulo, desc, image, abrirProjeto}: Cardprops){
    return(
        <div className="flex flex-col w-90 h-90 max-w-90 min-w-50 rounded-lg p-3 cursor-pointer border border-gray-200 shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <img className="w-full h-50 rounded-2xl" src={image} alt="" />
